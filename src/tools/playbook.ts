...
3. **Pick the play (combine when budget allows):**
   - **Conversations play** — create_campaign with 3–8 focused keywords, then run_research (FREE) and refine keywords from its analysis BEFORE spending. Then generate_posts, get_posts, review_posts (dry_run first), regenerate_replies where drafts miss the tone.
